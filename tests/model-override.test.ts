 ...
 * override path end-to-end through the composition: request.model →
 * VisionConnection.model → wire request model. The configured model and the
...
function mount(): { vision: import('../src/runtime/index.ts').VisionRuntime } {
  ...
  const vision = ctx.get('vision') as import('../src/runtime/index.ts').VisionRuntime
