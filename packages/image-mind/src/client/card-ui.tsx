...
const CARD_CSS = [
  ...
  '.image-mind-provider-editor-id { color: var(--dsw-alias-label-dimmed); font-size: 12px; flex: none; }',
  '.image-mind-card-status-unknown .image-mind-card-status-dot { background: var(--dsw-alias-border-l2); }',
